...
def print_acc(pred_list, label_list,args):
    ...
    with open(os.path.join("/home/hjy/work/opera/log/generalization/gqa_random/aokvqa/", '{}_seed{}.jsonl'.format(args.pope_type,args.seed)), "a") as f:
...
def main():
    ...
    args.pope_path = AOKVQA_PATH[args.pope_type]
    cfg = Config(args)
...
#     save_path = f'{base_dir}/pope-1000-random-blip-chat'
